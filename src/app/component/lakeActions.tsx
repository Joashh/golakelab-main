...
export default function AccessButtons() {
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      ...
      <button className="flex items-center cursor-pointer gap-1 px-3 py-2 text-sm font-medium bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg transition">
